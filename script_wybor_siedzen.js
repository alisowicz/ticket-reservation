...
elements.forEach(function(element) {
  element.addEventListener('click', function(){
    if (element.style.background == 'green')   {element.style.background = 'none'; sum = sum - 8; document.getElementById("cena").innerHTML = sum}
    else {element.style.background = 'green'; sum = sum + 8; document.getElementById("cena").innerHTML = sum + "zł" + "<br/>" + "<br/>" + "Wybrałeś miejsca? Zapraszamy poniżej do podsumowania zamówienia :)";  }
  });
});